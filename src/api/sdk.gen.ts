 ...
 */
export const setSessionLabel = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetSessionLabelData, ThrowOnError>) => {
    return (options?.client ?? client).put<SetSessionLabelResponse, SetSessionLabelError, ThrowOnError>({
        ...options,
 ...
 */
export const setKnowledgeLabel = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetKnowledgeLabelData, ThrowOnError>) => {
    return (options?.client ?? client).put<SetKnowledgeLabelResponse, SetKnowledgeLabelError, ThrowOnError>({
        ...options,
 ...
 */
export const removeKnowledgeTag = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RemoveKnowledgeTagData, ThrowOnError>) => {
    return (options?.client ?? client).delete<RemoveKnowledgeTagResponse, RemoveKnowledgeTagError, ThrowOnError>({
        ...options,
 ...
 */
export const addKnowledgeTag = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddKnowledgeTagData, ThrowOnError>) => {
    return (options?.client ?? client).put<AddKnowledgeTagResponse, AddKnowledgeTagError, ThrowOnError>({
        ...options,
        url: '/rest/knowledge/{id}/tag'
    });
};
