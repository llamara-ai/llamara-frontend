...
import type { ConfigurationData, ConfigurationResponses, GetModelsData, GetModelsResponses, GetModelsErrors, PromptData, PromptResponses, PromptErrors, GetSessionsData, GetSessionsResponses, GetSessionsErrors, CreateSessionData, CreateSessionResponses, CreateSessionErrors, DeleteSessionData, DeleteSessionResponses, DeleteSessionErrors, GetHistoryData, GetHistoryResponses, GetHistoryErrors, KeepAliveAnonymousSessionData, KeepAliveAnonymousSessionResponses, KeepAliveAnonymousSessionErrors, SetSessionLabelData, SetSessionLabelResponses, SetSessionLabelErrors, GetAllKnowledgeData, GetAllKnowledgeResponses, GetAllKnowledgeErrors, AddFileSourceData, AddFileSourceResponses, AddFileSourceErrors, RetryFailedIngestionData, RetryFailedIngestionResponses, RetryFailedIngestionErrors, UpdateFileSourceData, UpdateFileSourceResponses, UpdateFileSourceErrors, DeleteKnowledgeData, DeleteKnowledgeResponses, DeleteKnowledgeErrors, GetKnowledgeData, GetKnowledgeResponses, GetKnowledgeErrors, GetKnowledgeFileData, GetKnowledgeFileResponses, GetKnowledgeFileErrors, SetKnowledgeLabelData, SetKnowledgeLabelResponses, SetKnowledgeLabelErrors, RemoveKnowledgePermissionData, RemoveKnowledgePermissionResponses, RemoveKnowledgePermissionErrors, SetKnowledgePermissionData, SetKnowledgePermissionResponses, SetKnowledgePermissionErrors, RemoveKnowledgeTagData, RemoveKnowledgeTagResponses, RemoveKnowledgeTagErrors, AddKnowledgeTagData, AddKnowledgeTagResponses, AddKnowledgeTagErrors, DeleteUserDataData, DeleteUserDataResponses, DeleteUserDataErrors, LoginData, LoginResponses, LoginErrors } from './types.gen';
...
export const prompt = <ThrowOnError extends boolean = false>(options: Options<PromptData, ThrowOnError>) => {
    return (options.client ?? client).post<PromptResponses, PromptErrors, ThrowOnError>({
        bodySerializer: null,
        security: [
            {
                scheme: 'bearer',
...
export const getHistory = <ThrowOnError extends boolean = false>(options: Options<GetHistoryData, ThrowOnError>) => {
    return (options.client ?? client).get<GetHistoryResponses, GetHistoryErrors, ThrowOnError>({
...
export const keepAliveAnonymousSession = <ThrowOnError extends boolean = false>(options: Options<KeepAliveAnonymousSessionData, ThrowOnError>) => {
    return (options.client ?? client).put<KeepAliveAnonymousSessionResponses, KeepAliveAnonymousSessionErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const setSessionLabel = <ThrowOnError extends boolean = false>(options: Options<SetSessionLabelData, ThrowOnError>) => {
    return (options.client ?? client).put<SetSessionLabelResponses, SetSessionLabelErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getAllKnowledge = <ThrowOnError extends boolean = false>(options?: Options<GetAllKnowledgeData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAllKnowledgeResponses, GetAllKnowledgeErrors, ThrowOnError>({
...
export const addFileSource = <ThrowOnError extends boolean = false>(options: Options<AddFileSourceData, ThrowOnError>) => {
    return (options.client ?? client).post<AddFileSourceResponses, AddFileSourceErrors, ThrowOnError>({
...
export const retryFailedIngestion = <ThrowOnError extends boolean = false>(options: Options<RetryFailedIngestionData, ThrowOnError>) => {
    return (options.client ?? client).put<RetryFailedIngestionResponses, RetryFailedIngestionErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const updateFileSource = <ThrowOnError extends boolean = false>(options: Options<UpdateFileSourceData, ThrowOnError>) => {
    return (options.client ?? client).put<UpdateFileSourceResponses, UpdateFileSourceErrors, ThrowOnError>({
        ...formDataBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const deleteKnowledge = <ThrowOnError extends boolean = false>(options: Options<DeleteKnowledgeData, ThrowOnError>) => {
    return (options.client ?? client).delete<DeleteKnowledgeResponses, DeleteKnowledgeErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getKnowledge = <ThrowOnError extends boolean = false>(options: Options<GetKnowledgeData, ThrowOnError>) => {
    return (options.client ?? client).get<GetKnowledgeResponses, GetKnowledgeErrors, ThrowOnError>({
...
export const getKnowledgeFile = <ThrowOnError extends boolean = false>(options: Options<GetKnowledgeFileData, ThrowOnError>) => {
    return (options.client ?? client).get<GetKnowledgeFileResponses, GetKnowledgeFileErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const setKnowledgeLabel = <ThrowOnError extends boolean = false>(options: Options<SetKnowledgeLabelData, ThrowOnError>) => {
    return (options.client ?? client).put<SetKnowledgeLabelResponses, SetKnowledgeLabelErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const removeKnowledgePermission = <ThrowOnError extends boolean = false>(options: Options<RemoveKnowledgePermissionData, ThrowOnError>) => {
    return (options.client ?? client).delete<RemoveKnowledgePermissionResponses, RemoveKnowledgePermissionErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const setKnowledgePermission = <ThrowOnError extends boolean = false>(options: Options<SetKnowledgePermissionData, ThrowOnError>) => {
    return (options.client ?? client).put<SetKnowledgePermissionResponses, SetKnowledgePermissionErrors, ThrowOnError>({
        bodySerializer: null,
        security: [
            {
                scheme: 'bearer',
...
export const removeKnowledgeTag = <ThrowOnError extends boolean = false>(options: Options<RemoveKnowledgeTagData, ThrowOnError>) => {
    return (options.client ?? client).delete<RemoveKnowledgeTagResponses, RemoveKnowledgeTagErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const addKnowledgeTag = <ThrowOnError extends boolean = false>(options: Options<AddKnowledgeTagData, ThrowOnError>) => {
    return (options.client ?? client).put<AddKnowledgeTagResponses, AddKnowledgeTagErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const deleteUserData = <ThrowOnError extends boolean = false>(options?: Options<DeleteUserDataData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteUserDataResponses, DeleteUserDataErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const login = <ThrowOnError extends boolean = false>(options?: Options<LoginData, ThrowOnError>) => {
    return (options?.client ?? client).get<LoginResponses, LoginErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
