 ...
 * Send a prompt to the given chat model.
 */
export const sendPromptStreamResponse = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SendPromptStreamResponseData, ThrowOnError>) => {
    return (options?.client ?? client).post<SendPromptStreamResponseResponse, SendPromptStreamResponseError, ThrowOnError>({
        ...options,
        url: '/rest/chat/prompt/stream'
    });
};
